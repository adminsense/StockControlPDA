...
**Source of truth for the next PDA UI:** interactive HTML [`docs/pda-move-stock.html`](../docs/pda-move-stock.html) and screenshot **`readme/images/mock_pda_v2.png`** (also shown below). The legacy `mock_template.png` wireframe is **not** used anymore.
